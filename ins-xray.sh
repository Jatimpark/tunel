...
wget -q -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/cok/tunel/main/tools/nginx.conf" 
#mkdir -p /home/vps/public_html
wget -q -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/cok/tunel/main/tools/vps.conf"
...
EOF
sed -i '$ ilocation /aryapro ' /etc/nginx/conf.d/xray.conf
...
sed -i '$ i                   rewrite /(.*) /vless break;' /etc/nginx/conf.d/xray.conf
sed -i '$ i{' /etc/nginx/conf.d/xray.conf
sed -i '$ iproxy_redirect off;' /etc/nginx/conf.d/xray.conf
...
sed -i '$ i                   if ($http_upgrade != "Upgrade") {' /etc/nginx/conf.d/xray.conf
sed -i '$ i                   rewrite /(.*) /servlets break;' /etc/nginx/conf.d/xray.conf
sed -i '$ i{' /etc/nginx/conf.d/xray.conf
sed -i '$ iproxy_redirect off;' /etc/nginx/conf.d/xray.conf
...
sed -i '$ i                   if ($http_upgrade != "Upgrade") {' /etc/nginx/conf.d/xray.conf
sed -i '$ i                   rewrite /(.*) /trojan-ws break;' /etc/nginx/conf.d/xray.conf
sed -i '$ i{' /etc/nginx/conf.d/xray.conf
sed -i '$ iproxy_redirect off;' /etc/nginx/conf.d/xray.conf
