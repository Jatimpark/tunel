...
ver=$( curl https://raw.githubusercontent.com/${GitUser}/tunel/main/version )
clear
# LINE COLOUR
line=$(cat /etc/line)
# TEXT COLOUR BELOW
...
version=$(cat /home/ver)
new_version=$( curl https://raw.githubusercontent.com/${GitUser}/tunel/main/newversion | grep $version )
#Status Version
...
echo -e "   \e[$below SSTATUS UPDATE XRAY >> $sts"
echo -e ""
...
# UPDATE RUN-UPDATE
cd /usr/bin
wget -O run-up "https://raw.githubusercontent.com/${GitUser}/tunel/main/options/up.sh"
chmod +x run-up
# RUN UPDATE
echo ""
clear
