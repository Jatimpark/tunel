...
echo -e " ${BICyan}│  ${ICyan} Hostname     : ${NC}$HOSTNAME                          ${BICyan}│${NC} "
echo -e " ${BICyan}│  ${ICyan} Public IP    : ${NC}$IPVPS                      ${BICyan}│${NC} "
echo -e " ${BICyan}│  ${ICyan} Domain       : ${NC}(cat /etc/xray/domain)            ${BICyan}│${NC} "
echo -e " ${BICyan}│  ${ICyan} ISP          : ${NC}$ISP        ${BICyan}│${NC} "
echo -e " ${BICyan}│  ${ICyan} Total RAM    : ${NC}${totalram}MB                             ${BICyan}│${NC} "
echo -e " ${BICyan}│  ${ICyan} Usage Memory :${NC} $MEMOFREE                             ${BICyan}│${NC} "
echo -e " ${BICyan}│  ${ICyan} LoadCPU      : ${NC}$LOADCPU%                                 ${BICyan}│${NC} "
echo -e " ${BICyan}│  ${ICyan} Core System  : ${NC}$CORE                                  ${BICyan}│${NC} "
echo -e " ${BICyan}│  ${ICyan} System OS    : ${NC}$MODEL                                   ${BICyan}│${NC} "
echo -e " ${BICyan}│  ${ICyan} Date         : ${NC}$DATEVPS                         ${BICyan}│${NC} "
echo -e " ${BICyan}│  ${ICyan} Time         : ${NC}$TIMEZONE                           ${BICyan}│${NC} "
echo -e " ${BICyan}└─────────────────────────────────────────────────────┘${NC}"
echo -e " ${BICyan}╭═════════════════════════════════════════════════════╮${NC}"
echo -e "${BICyan} │                    ${NC}SSH     ${RED}: ${BIYellow}$ssh1                      ${BICyan}│${NC} "
echo -e "${BICyan} │                    ${NC}ALLXRAY ${RED}: ${BIYellow}$vma                       ${BICyan}│${NC} "
echo -e " ${BICyan}╰═════════════════════════════════════════════════════╯${NC}"
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
...
echo -e "${BICyan} │    ${ICyan}[${GREEN}07${ICyan}]${NC} • CLEAR S    "  "${BICyan}│    ${ICyan}[${GREEN}14${ICyan}]${NC} • SETTING SET       ${BICyan}│${NC}"
echo -e " ${BICyan}╰═════════════════════════════════════════════════════╯${NC}"
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
