...
# Getting
#export CHATID="1659428164"
#export KEY="6468426322:AAH1spIVqOUXX10760uAa9j5jbMcmObalsY"
#export TIME="10"
...
data_ip="https://raw.githubusercontent.com/Jatimpark/permission/main/ip"
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      \033[0;36mTelegram${NC} t.me/Etil"
    echo -e "      ${GREEN}WhatsApp${NC} wa.me/6287721815317"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    exit
  fi
}
...
echo -e "$iplimit" > /etc/scrz-prem/limit/vless/ip/$user
else
echo > /dev/null
fi
