...
echo -e "└─────────────────────────────────────────┘"
sleep 1
wget -q https://raw.githubusercontent.com/Jatimpark/tunel/main/tools/vnstat.sh && chmod +x vnstat.sh && ./vnstat.sh
echo -e "┌─────────────────────────────────────────┐"
...
echo -e "└─────────────────────────────────────────┘"
sleep 1
wget -q https://raw.githubusercontent.com/Jatimpark/tunel/main/backup/set-br2.sh && chmod +x set-br2.sh && ./set-br2.sh
sleep 2
...
wget -q -O /usr/bin/renewtrgo "https://raw.githubusercontent.com/Jatimpark/tunel/main/trgo/renewtrgo.sh"
wget -q -O /usr/bin/trojaan "https://raw.githubusercontent.com/Jatimpark/tunel/main/trgo/trojaan.sh"
...
echo  "   - XRAY  Vmess TLS         : 443, 8443, 2096, 2087" | tee -a log-install.txt
echo  "   - XRAY  Vmess None TLS    : 80, 8080, 8880, 2082" | tee -a log-install.txt
echo  "   - XRAY  Vless TLS         : 443, 8443, 2096, 2087" | tee -a log-install.txt
echo  "   - XRAY  Vless None TLS    : 80, 8080, 8880, 2082" | tee -a log-install.txt
echo  "   - Trojan GRPC             : 443, 8443, 2096, 2087" | tee -a log-install.txt
echo  "   - Trojan WS               : 443, 8443, 2096, 2087" | tee -a log-install.txt
echo  "   - Trojan Go               : 2053" | tee -a log-install.txt
echo  "   - Sodosok WS/GRPC         : 443, 8443, 2096, 2087" | tee -a log-install.txt
