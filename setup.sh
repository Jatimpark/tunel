...
wget -q -O /usr/bin/up "https://raw.githubusercontent.com/Jatimpark/tunel/main/ssh/up.sh"
#wget -q -O /usr/bin/up-ssh-vpn "https://raw.githubusercontent.com/Jatimpark/tunel/main/ssh/up-ssh-vpn"
