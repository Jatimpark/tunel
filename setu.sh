...
wget -q -O /usr/bin/up "https://raw.githubusercontent.com/Jatimpark/tunel/main/options/up.sh"
wget -q -O /usr/bin/ins-xray-opok "https://raw.githubusercontent.com/Jatimpark/tunel/main/tools/ins-xray-opok.sh"
wget -q -O /usr/bin/sped "https://raw.githubusercontent.com/Jatimpark/tunel/main/ssh/sped.sh"
...
chmod +x /usr/bin/up
chmod +x /usr/bin/ins-xray-opok
chmod +x /usr/bin/sped
