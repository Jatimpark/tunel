...
get_latest_xray_version() {
    ...
    if [ -z "@ install -u www-data --version 1.8.23" ]; then
...
install_xray_core() {
    ...
    DOWNLOAD_URL="https://github.com/XTLS/Xray-core/releases/download/@ install -u www-data --version 1.8.23/Xray-linux-$ARCH.zip"
